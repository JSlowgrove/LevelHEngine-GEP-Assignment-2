...
S_State::S_State(S_StateManager * stateManager, SDL_Renderer* renderer, Maths::Vec2 dimensions)
	: stateManager(stateManager), renderer(renderer), dimensions(dimensions), window(nullptr)
{
}

S_State::S_State(S_StateManager * stateManager, SDL_Window* window, Maths::Vec2 dimensions)
