...
RM_Object::RM_Object(std::string objFileName)
{
...
/*Constructs an Object.*/
RM_Object::RM_Object(std::string objFileName, std::string material)
{
	/*store the material*/
...
void RM_Object::InitialiseVAO(std::string objFileName)
{
	/*Creates one VAO*/
	...
	ResourceManagment::FileLoader::loadOBJFile(objFileName, vertices, vertexNormals, vertexTextures);
...
/*Initialise the texture.*/
void RM_Object::initialiseTexture(std::vector<float> vertexTextures)
{
...
unsigned int RM_Object::getNumberOfVertices()
{
