...
void RM_Model::draw(glm::mat4 &viewMatrix, glm::mat4 &projMatrix)
{
...
void RM_Model::setPosition(glm::vec3 position)
{
	/*set the position*/
...
/*Sets the position of the Model.*/
void RM_Model::setPosition(float x, float y, float z)
{ 
	/*set the x position*/
	position.x = x; 
	/*set the y position*/
...
/*Rotate the Model.*/
void RM_Model::rotate(glm::vec3 rotation)
{
	/*rotate the model*/
...
void RM_Model::rotateX(float angle)
{
	/*rotate the model*/
...
void RM_Model::rotateY(float angle)
{
	/*rotate the model*/
...
void RM_Model::rotateZ(float angle)
{
	/*rotate the model*/
...
/*Scale the Model.*/
void RM_Model::scale(glm::vec3 scaleVector)
{
	/*scale the model*/
