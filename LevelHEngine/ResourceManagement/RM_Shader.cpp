...
RM_Shader::RM_Shader(std::string vertexShaderFileName, std::string fragmentShaderFileName)
{
...
/*Initialise a shader.*/
void RM_Shader::initaliseShader(std::string shaderFileName, char shaderType)
{
	/*create a shader*/
	GLuint shader;
	...
	std::string shaderFile = ResourceManagment::FileLoader::loadShaderFile(shaderFileName);
...
bool RM_Shader::CheckShaderCompiled(GLint shader)
{
...
GLuint RM_Shader::getShaderProgram()
{
...
GLint RM_Shader::getModelMatrixLocation()
{
...
GLint RM_Shader::getViewMatrixLocation()
{
...
GLint RM_Shader::getShaderProjectionMatrixLocation()
{
...
GLint RM_Shader::getTextureSamplerLocation()
{
