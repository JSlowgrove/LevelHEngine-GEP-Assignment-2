#include "RM_FileLoader.h"

/**************************************************************************************************************/

/*Load the contents of a shader file in to a std::string.*/
std::string RM_FileLoader::loadShaderFile(std::string fileName)
{
...
void RM_FileLoader::loadOBJFile(std::string objFileName, std::vector<float> &vertices,
...
void RM_FileLoader::loadXYZFloats(std::stringstream &streamLine, std::vector<float> &vectorArray)
{
...
void RM_FileLoader::loadUVFloats(std::stringstream &streamLine, std::vector<float> &vectorArray)
{
...
void RM_FileLoader::sortWithIndices(std::stringstream &streamLine, 
