...
public:
	...
	*/
	UI_UIObject(float x, float y, float width, float height);
	...
	@param surface A pointer to the surface for the texture.
	*/
	UI_UIObject(float x, float y, float width, float height, SDL_Surface* surface);
